@Google_existing_paid_login
Feature: Login with Google existing paid account test

  Scenario: Login with Google existing paid account
  ...
  And user enters the username and passwordiii 
