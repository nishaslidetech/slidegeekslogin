@facebook_existing_paid_login
Feature: Login with existing facebook paid account test

  Scenario: Login with existing facebook paid account test
  ...
  And user Enters the username and passwordi
